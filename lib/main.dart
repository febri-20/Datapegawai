...
Future<List<Pegawai>> fetchPegawais(http.Client client) async {
  final response =
      await client.get('https://febri20.000webhostapp.com/readDatajson.php');
...
class Pegawai {
  ...
  Pegawai({this.nip, this.nama_pegawai, this.dapatemen, this.jabatan, this.pendidikan_terakhir});
